...
figure
plot(r_array,steady_state_array)
title('How eta affects Steady State Error')
xlabel('eta')
...
plot(r_array,Stable)
xlabel('eta')
ylabel('Stable Boolean')

figure
plot(r_array,set_time_array)
title('How eta affects Settling Time')
xlabel('eta')
ylabel('5% Settling Time')
